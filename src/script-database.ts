...
async function mockDataDatabase(): Promise<void> {
  ...
  try {
    ...
    //   INSERT INTO user (id, name, surname, email, password, birthDate, province, locality, latitud, longitud) VALUES 
    //   ('${user1Id}', 'Alice', 'Smith', 'alice@example.com', 'password123', '1996-02-19 00:00:00', 'Neuquén', 'San Carlos de Bariloche', -41.1456, -71.3082),
    //   ('${user2Id}', 'Bob', 'Johnson', 'bob@example.com', 'password456', '1996-02-19 00:00:00', 'Mendoza', 'Mendoza Capital', -32.8908, -68.8272),
    //   ('${user3Id}', 'Charlie', 'Brown', 'charlie@example.com', 'password789', '1996-02-19 00:00:00', 'Santa Fe', 'Rosario', -32.9468, -60.6393),
    //   ('testid1', 'Mock', 'User', 'mockuser@example.com', 'password111', '1996-02-19 00:00:00', 'La Plata', 'Buenos Aires', -32.9468, -60.6393);
    // `);
...
await connection.query(`
  INSERT INTO trip (id, origin, destination, startDate, description, estimatedCost, numberOfRegistrants, latitud, longitud) VALUES 
